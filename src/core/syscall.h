...
static const syscall_t g_syscalls[330] = {
    ...
    {222, "timer_create", 3, NUM, CLOCKID_T, STRUCT_SIGEVENT_P,
        TIMER_T_P, 0, 0, 0},
    ...
    {303, "name_to_handle_at", 5, NUM, NUM, STRING,
        STRUCT_FILE_HANDLE_P, NUM_P, NUM, 0},
    {304, "open_by_handle_at", 3, NUM, NUM, STRUCT_FILE_HANDLE_P,
        NUM, 0, 0, 0},
